...
![Lifecycle for predictive models](Lifecycle.png)
...
john <- data.frame(Gender = factor("Male", levels = c("Male", "Female")),
                   Age = 76,
                   Cardiovascular.Diseases = factor("Yes", levels = c("No", "Yes")), 
                   Diabetes = factor("No", levels = c("No", "Yes")), 
                   Neurological.Diseases = factor("No", levels = c("No", "Yes")), 
                   Kidney.Diseases = factor("No", levels = c("No", "Yes")), 
                   Cancer = factor("No", levels = c("No", "Yes")))
john
```
...
```{r, message=FALSE, warning=FALSE, fig.width=6, fig.height=2.5}
ppart_tuned <- predict_parts(model_tuned, john)
plot(ppart_tuned)
```
